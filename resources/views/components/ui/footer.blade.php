    ...
    <div class="container-custom">
        ...
        <div class="site-footer__grid">
            ...
            <div>
                ...
                <h3 class="site-footer__brand-name">Al Kayan Technology</h3>
            ...
            <div>
                ...
                <div class="site-footer__contact">
                    ...
                    @endif
                    @if ($phone)
                        <a href="tel:{{ preg_replace('/\s+/', '', $phone) }}" class="site-footer__contact-item site-footer__link">{{ $phone }}</a>
                    @endif
                    @if ($location)
