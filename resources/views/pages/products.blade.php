...
<div
    class="pdp"
    x-data="productShowcase({{ $productItems->toJson() }})"
    x-init="init()"
>
    {{-- Hero --}}
    ...
    <section class="pdp-stage container-custom">
        ...
        <div class="pdp-spotlight" aria-live="polite">
            <div class="pdp-spotlight__media">
                <img
                    x-bind:src="activeProduct().image"
                    x-bind:alt="activeProduct().name"
                    width="720"
                    height="720"
                    loading="eager"
                    decoding="async"
            ...
            <div class="pdp-spotlight__body">
                <div class="pdp-spotlight__content" x-bind:data-phase="spotlightPhase">
                    ...
                    <a
                        x-bind:href="displayedProduct().inquiry"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="btn-base btn-primary pdp-spotlight__cta"
                    >{{ __('site.products.inquiry') }}</a>
                </div>
            </div>
        </div>
            ...
            @foreach($products as $index => $product)
                ...
                >
                    ...
                    <div class="pdp-item__body">
                        ...
                        <p class="pdp-item__desc">{{ Str::limit($product->description ?: __('site.products.default_description'), 120) }}</p>
                    </div>
